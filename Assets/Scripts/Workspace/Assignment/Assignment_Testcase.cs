...
namespace Assignment
{
    public class Assignment_Testcase
    {
        ...
        [TestCase(new int[] { 5, 2, 8, 1, 9 }, new int[] { 1, 2, 5, 8, 9 })]
        ...
        [TestCase(new int[] { 3, 1, 3, 2, 1 }, new int[] { 1, 1, 2, 3, 3 })]
        ...
        [TestCase(new int[] { 12, 11, 13, 5, 6 }, new int[] { 5, 6, 11, 12, 13 })]
        [TestCase(new int[] { -5, 2, -3, 8, 0 }, new int[] { -5, -3, 0, 2, 8 })]
        ...
        [TestCase(new int[] { 5, 2, 8, 1, 9 }, new int[] { 9, 8, 5, 2, 1 })]
        [TestCase(new int[] { 7, 3, 7, 1, 3 }, new int[] { 7, 7, 3, 3, 1 })]
        ...
        [TestCase(new int[] { 64, 34, 25, 12, 22, 11, 90 }, new int[] { 90, 64, 34, 25, 22, 12, 11 })]
        [TestCase(new int[] { 9, 7, 5, 3, 1 }, new int[] { 9, 7, 5, 3, 1 })]
        ...
        [TestCase(new int[] { 12, 11, 13, 5, 6 }, new int[] { 13, 12, 11, 6, 5 })]
        [TestCase(new int[] { -5, 2, -3, 8, 0 }, new int[] { 8, 2, 0, -3, -5 })]
        ...
        [TestCase(new int[] { 5, 5, 4, 3, 2 }, 4)]
        [TestCase(new int[] { 3, 7, 1, 9, 5 }, 7)]
        [TestCase(new int[] { -1, -5, 3, 0, 2 }, 2)]
        ...
        [TestCase(new int[] { 1, 9, 3, 10, 4, 20, 2 }, 4)]
        [TestCase(new int[] { 5, 4, 3, 2, 1 }, 5)]
        [TestCase(new int[] { 1, 3, 5, 7, 9 }, 1)]
        [TestCase(new int[] { 1, 2, 2, 3, 4 }, 4)]
        [TestCase(new int[] { 42 }, 1)]
        [TestCase(new int[] { 100, 4, 200, 1, 3, 2, 101, 102 }, 4)]
        [TestCase(new int[] { -2, -1, 0, 1, 2, 5 }, 5)]
